/**
 * FinanceDashboard — Decision Economics Dashboard.
 * Per-team & per-project: ROI, Cost-to-Company, Revenue, Profit, Risk Exposure.
 * Plus intervention cost-benefit matrix with verdict logic.
 */
...
const riskBadge = (blocked: number) => {
  if (blocked > 1) return { label: 'HIGH EXPOSURE', color: 'bg-red-500/20 text-red-400' };
  if (blocked === 1) return { label: 'MODERATE', color: 'bg-amber-500/20 text-amber-400' };
...
const FinanceDashboard = () => {
  ...
  const roiChartData = teams.map((t: any) => ({
    name: t.name?.replace(' Team', '') || 'Unknown',
    roi: t.roi || 0,
  }));

  const projectPieData = costAnalysis.map((p: any, i: number) => ({
    name: p.project_name,
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Decision Economics</h1>
            <p className="text-sm text-muted-foreground">
              ROI • Cost-to-Company • Revenue • Profit • Risk Exposure
            </p>
          </div>
        </div>
        {/* Tab Switcher */}
            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="rounded-xl border bg-card p-5">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-sm font-semibold">Revenue vs Cost-to-Company by Team</h3>
                  </div>
                ...
                <div className="rounded-xl border bg-card p-5">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-sm font-semibold">Cost Distribution by Project</h3>
                  </div>
                  <ResponsiveContainer width="100%" height={240}>
                    <RPieChart>
                      <Pie
              ...
              <div className="rounded-xl border bg-card p-5">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-sm font-semibold">Return on Investment by Team</h3>
                </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 className="text-lg font-semibold">Intervention Cost-Benefit Matrix</h2>
                </div>
