    ...
    return (
      <div className="flex h-96 items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/role-dashboard" className="text-primary hover:underline">
      ...
      >
        <div>
          <div className="flex items-center gap-2 text-xs font-medium text-muted-foreground mb-2">
            <Link to="/role-dashboard" className="hover:text-foreground transition-colors flex items-center gap-1">
              Dashboard
            </Link>
